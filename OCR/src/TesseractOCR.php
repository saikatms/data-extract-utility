<?php 
namespace OCR\TesseractOCR;

// use OCR\TesseractOCR\Command;
// use OCR\TesseractOCR\Option;
// use OCR\TesseractOCR\FriendlyErrors;
include_once __DIR__."/imageToTextData/Command.php";
include_once __DIR__."/imageToTextData/FriendlyErrors.php";
include_once __DIR__."/imageToTextData/Option.php";
include_once __DIR__."/imageToTextData/Process.php";
