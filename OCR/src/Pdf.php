...
use Imagick;
use OCR\PdfToImage\Exceptions\InvalidFormat;
use OCR\PdfToImage\Exceptions\PageDoesNotExist;
use OCR\PdfToImage\Exceptions\PdfDoesNotExist;
...
class Pdf
{
     ...
     * @return $this
     *
     * @throws \OCR\PdfToImage\Exceptions\InvalidLayerMethod
     *
